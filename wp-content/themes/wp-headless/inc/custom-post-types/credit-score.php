...
if ( ! function_exists('cpt_creditscore') ) {
    function cpt_creditscore() {
        ...
        $args = array(
            ...
            'description'         => __( $singular . ' Credit Score Custom Post Type', 'text_domain' ),
            'labels'              => $labels,
            ...
            'graphql_single_name' => 'creditscore',
            'graphql_plural_name' => 'creditscores',
        );
        register_post_type( 'creditscore', $args );
    }

    add_action( 'init', 'cpt_creditscore', 1 );
}

function creditscore_archive_options() {

  if(function_exists('acf_add_options_page')) {
    acf_add_options_sub_page(array(
      'page_title'      => 'Credit Score Archive Settings',
      'parent_slug'     => 'edit.php?post_type=creditscore',
...
add_action('init', 'creditscore_archive_options');
